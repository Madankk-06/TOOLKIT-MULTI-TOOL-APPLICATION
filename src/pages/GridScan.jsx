...
export const GridScan = ({
  ...
  useEffect(() => {
    ...
    const onMove = e => {
      ...
      // Use window-level coordinates so cursor tracking works even with pointerEvents: none
    ...
    // Attach to window for global cursor tracking (works even with pointerEvents: none overlay)
